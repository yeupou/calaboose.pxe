...
# UPDATED VERSION AT
#         https://gitlab.com/yeupou/calaboose.pxe/raw/master/GNUkFreeBSD/ipxe-boot-update.sh
#
#                                 |     |
#                                 \_V_//
#                                 \/=|=\/
...
#
# FILE DISCONTINUED H
#         https://gitlab.com/yeupou/bada/raw/master/GNUkFreeBSD/ipxe-boot-update.sh
#
#                                 |     |
#                                 \_V_//
#                                 \/=|=\/
